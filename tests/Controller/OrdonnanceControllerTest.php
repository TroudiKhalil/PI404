...
class OrdonnanceControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'ordonnance[frequence]' => 'Testing',
            'ordonnance[dose]' => 'Testing',
            'ordonnance[date_creation]' => 'Testing',
            'ordonnance[id_Consultation]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'ordonnance[frequence]' => 'Something New',
            'ordonnance[dose]' => 'Something New',
            'ordonnance[date_creation]' => 'Something New',
            'ordonnance[id_Consultation]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getDose());
